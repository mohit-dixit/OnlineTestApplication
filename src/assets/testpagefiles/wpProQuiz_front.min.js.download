		...
		*/
		...
		var timelimit = (function() {
			...
			instance.start = function() {
				...
				var $timeDivs = globalElements.timelimit.find('.chart');
				...
				_intervalId = window.setInterval(function() {
					...
					$timeDivs.css('width', (remainingTime / full * 100));
...
//				plugin.methode.scrollTo($element, 1);
			...
			nextQuestion: function() {
				...
				/*by gaurav dixit*/
				var checked = currentQuestion.find('ul').find('li input:checked').length;
				if(checked==1){
				   //currentQuestion.find('ul').find('li input').attr('disabled','disabled');
			    }
			    /*by gaurav dixit*/
...
//						$questionList.sortable("destroy");
			...
			loadQuizDataAjax: function(quizStart) {
				plugin.methode.ajax({
					...
					jQuery('.quiz-description').hide();
					jQuery('.quiz-inner-bg').show();
		...
		plugin.preInit = function() {
			...
			//	alert('test');
				$e.find('.TEST').css('visibility','hidden');
